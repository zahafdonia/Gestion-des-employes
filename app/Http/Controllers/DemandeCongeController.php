...
class DemandeCongeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.demande_conge.index')->with('success', 'Demande de congé soumise.');
    }
    ...
    public function updateStatus(Request $request, $id)
{
    ...
    return redirect()->route('user.demande_conge.index')->with('success', 'Le statut de la demande a été mis à jour.');
}
}
