...
class LocalMissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Ajouter des valeurs fictives pour les champs requis
        $validatedData['user_id'] = 1; // ID utilisateur fictif
        $validatedData['employee_id'] = 'EMP123'; // Utiliser employee_id pour correspondre à la colonne dans la table
    ...
    {
        // Récupère toutes les missions pour un employé fictif
        $missions = LocalMission::where('employee_id', 'EMP123')->get(); // Donnée fictive
