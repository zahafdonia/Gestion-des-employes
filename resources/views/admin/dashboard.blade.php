    ...
    <div class="d-flex">
        ...
        <nav class="sidebar bg-dark text-white">
            <ul class="list-unstyled p-3">
                ...
                <li><a href="{{ route('admin.demande_conge.conges') }}" class="text-white">Gérer les congés</a></li>
                <li><a href="{{ route('admin.gereEmpl.create') }}" class="text-white">Ajouter Employés</a></li>
                <li><a href="{{ route('admin.demande_conge.analyser_congees') }}" class="text-white">Analyser les Congés</a></li>
                <li><a href="{{ route('login') }}" class="text-white">Déconnecter</a></li>
