...
<div class="container mt-5">
    <h1 class="text-center mb-4">Gestion des Missions Internationales</h1>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr class="table-light">
                ...
                <td>
                    <form action="{{ route('missions.international.approve', 1001) }}" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn btn-success btn-sm">Approuver</button>
                    </form>
                    <form action="{{ route('missions.international.reject', 1001) }}" method="POST" class="d-inline">
                        @csrf
            ...
            <tr class="table-light">
                ...
                <td>
                    <form action="{{ route('missions.international.approve', 1005) }}" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn btn-success btn-sm">Approuver</button>
                    </form>
                    <form action="{{ route('missions.international.reject', 1005) }}" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn btn-danger btn-sm">Rejeter</button>
                    </form>
                </td>
