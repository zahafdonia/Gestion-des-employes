...
<head>
    ...
    <title>Primes de l'Employé</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Primes de l'Employé</h1>
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">Aucune prime trouvée pour cet employé</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
